...
| [`docs/ARQUITECTURA.md`](docs/ARQUITECTURA.md) | **Diagramas** de arquitectura y funcionalidades (Mermaid) |
| [`docs/ENTORNOS.md`](docs/ENTORNOS.md) · [`CHANGELOG.md`](CHANGELOG.md) | Modelo Dev→QA→Prod y bitácora de cambios |

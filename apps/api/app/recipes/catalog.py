...
RECIPES: list[dict] = [
    ...
    _r(
        ...
        inputs=[
            ...
            {"key": "objetivo", "type": "text", "label": "¿Cuál es tu objetivo?",
             "placeholder": "Ej. detectar correos urgentes de clientes y qué responder hoy",
             "help": "Dile qué buscas lograr para que el resumen sea a la medida."},
            {"key": "notas", "type": "text", "label": "Qué necesitas / cómo lo necesitas",
             "placeholder": "Ej. enfócate en facturación; agrúpalo por cliente; en viñetas y con acciones sugeridas",
             "help": "En qué enfocarte (clientes, temas, remitentes) y el formato/estilo que prefieres."},
        ],

...
TRAMITES: list[dict] = [
    ...
    # ===== México — más nacional/estatal =====
    _t(id="mx_proteccion_civil", country="MX", scope="estatal",
       category="cumplimiento", eje="seguridad",
       title="Dictamen / visto bueno de Protección Civil",
       authority="Unidad de Protección Civil (estatal/municipal)",
       requisitos=["Programa interno (según giro/aforo)", "Extintores y señalización",
                   "Rutas de evacuación", "Pago de derechos"],
       pasos=["Determina nivel de riesgo del giro", "Elabora programa interno si aplica",
              "Solicita inspección", "Obtén el dictamen"],
       costo_aprox="Variable por giro/superficie", vigencia="Anual",
       fuente="", keywords=["protección civil", "dictamen", "visto bueno", "riesgo", "extintores"]),
    _t(id="mx_se_denominacion", country="MX", scope="nacional", category="abrir", eje="economia",
       title="Autorización de denominación social (constitución de empresa)",
       authority="Secretaría de Economía",
       requisitos=["Propuestas de nombre", "e.firma"],
       pasos=["Solicita la denominación en tuempresa.gob.mx", "Reserva el nombre",
              "Acude con notario/fedatario para constituir", "Inscribe en el RPC"],
       costo_aprox="Gratuito (denominación) + honorarios notariales",
       fuente="https://www.gob.mx/se", keywords=["denominación", "razón social", "constituir", "sociedad", "notario"]),
    _t(id="mx_yuc_mer_licencia", country="MX", scope="municipal", region="Yucatán", municipio="Mérida",
       category="abrir", eje="economia",
       title="Licencia de funcionamiento — Mérida",
       authority="Ayuntamiento de Mérida",
       requisitos=["Uso de suelo / factibilidad", "Identificación", "Comprobante de domicilio del local"],
       pasos=["Verifica factibilidad", "Ingresa solicitud en ventanilla/ línea", "Paga derechos",
              "Recibe licencia"],
       costo_aprox="Variable por giro", vigencia="Anual",
       fuente="https://www.merida.gob.mx", keywords=["licencia", "mérida", "yucatán", "funcionamiento"]),

    # ===== Ecuador / Guatemala =====
    _t(id="ec_ruc_sri", country="EC", scope="nacional", category="cumplimiento", eje="economia",
       title="Obtención del RUC (SRI)",
       authority="Servicio de Rentas Internas (SRI)",
       requisitos=["Cédula/identificación", "Comprobante de domicilio", "Actividad económica"],
       pasos=["Agenda turno o usa SRI en línea", "Registra el RUC", "Selecciona régimen (RIMPE)",
              "Emite comprobantes"],
       costo_aprox="Gratuito", fuente="https://www.sri.gob.ec",
       keywords=["ruc", "sri", "ecuador", "rimpe", "impuestos"]),
    _t(id="gt_nit_sat", country="GT", scope="nacional", category="cumplimiento", eje="economia",
       title="Inscripción NIT (SAT Guatemala)",
       authority="Superintendencia de Administración Tributaria (SAT)",
       requisitos=["DPI", "Dirección", "Actividad económica"],
       pasos=["Ingresa a Agencia Virtual SAT", "Inscribe el NIT", "Selecciona régimen (pequeño contribuyente)",
              "Habilita facturación"],
       costo_aprox="Gratuito", fuente="https://portal.sat.gob.gt",
       keywords=["nit", "sat", "guatemala", "régimen", "pequeño contribuyente"]),
]

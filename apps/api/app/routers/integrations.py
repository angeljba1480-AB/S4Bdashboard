...
CONNECTOR_TEMPLATES: list[dict] = [
    ...
    {"id": "sap_s4hana", "kind": "erp", "name": "SAP S/4HANA (OData)", "auth_header": "Authorization",
     "base_url": "https://<host>:<puerto>/sap/opu/odata/sap/<SERVICIO>/<EntitySet>",
     "auth_hint": "Basic <base64 usuario:clave> · escritura requiere X-CSRF-Token (ver nota)",
     "payload_example": {"d": {"Field1": "valor", "Field2": "valor"}}},
    {"id": "sap_b1", "kind": "erp", "name": "SAP Business One (Service Layer)", "auth_header": "Cookie",
     "base_url": "https://<host>:50000/b1s/v1/<Recurso>",
     "auth_hint": "Login en /b1s/v1/Login → usa la cookie B1SESSION en este header",
     "payload_example": {"CardCode": "C0001", "DocDate": "2026-01-01", "DocumentLines": [{"ItemCode": "A1", "Quantity": 1}]}},
    {"id": "make", "kind": "custom", "name": "Make (Integromat)", "auth_header": "Authorization",
     "base_url": "https://hook.<region>.make.com/<id-del-webhook>",
     "auth_hint": "Crea un escenario que empiece con 'Custom webhook' y pega aquí su URL (token opcional)",
